...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; position: absolute; z-index: 10; top: -100vh; left: -17vw; height: 20vh; object-fit: cover; background-size: cover!important; width: 10vw; opacity: 1; background: url('https://github.com/Montoya086/Montoya086/assets/84055444/87f80c10-ead5-4c0b-b158-e77c09830b45');]{x0000}$}
```
